      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between">
        <div>
          <img 
            ...
            loading="eager" 
          />
          <h1 className="text-4xl font-bold tracking-tight text-gray-800 sm:text-5xl dark:text-white" id="contact">
            Hi! I'm César Alexander
          </h1>
          <p className="tracking-[0.06em] text-xl text-zinc-200">
            A computer science student, focused on web development and data engineering.
          </p>
          <div className="md:w-full mt-6 text-xl text-zinc-200">
          ...
          <div className="inline-flex mt-10 space-x-6 justify-items-start items-center font-light">
            <span className="text-xl text-zinc-200">Contact:</span>
            <a className="px-2 py-1 transition" href="https://github.com/cesaralexanderds/" target="_blank" rel="noopener noreferrer">
              <img src="/github-mark-white.svg" className="h-7 hover:scale-[1.15] transition" alt="GitHub" />
            </a>
            <a className="px-2 py-1 transition hover:scale-[1.15]" href="https://www.linkedin.com/in/c-a-d-s/" target="_blank" rel="noopener noreferrer">
            ...
            <a className="px-2 py-1 transition hover:scale-[1.15]" href="mailto:cesaralexanderds@gmail.com" target="_blank" rel="noopener noreferrer">
              <svg className="h-8 w-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
