...
function requireReplaceSymbols () {
	...
	const replaceValueSymbols = requireReplaceValueSymbols();
...
function requireSrc$4 () {
	...
	hasRequiredSrc$4 = 1;
	const replaceValueSymbols = requireReplaceValueSymbols();
	const replaceSymbols = requireReplaceSymbols();
	const extractICSS = requireExtractICSS();
	const createICSSRules = requireCreateICSSRules();
...
function requireLocalsConvention () {
	...
	var _lodash = _interopRequireDefault(requireLodash_camelcase());
...
function requireSrc$3 () {
	...
	hasRequiredSrc$3 = 1;
	const topologicalSort = requireTopologicalSort();
...
function requireSrc$2 () {
	...
	const { extractICSS } = requireSrc$4();
...
function requireScoping () {
	...
	var _postcssModulesExtractImports = _interopRequireDefault(requireSrc$3());

	var _genericNames = _interopRequireDefault(requireGenericNames());

	var _postcssModulesLocalByDefault = _interopRequireDefault(requireSrc$2());

	var _postcssModulesScope = _interopRequireDefault(requireSrc$1());

	var _stringHash = _interopRequireDefault(requireStringHash());

	var _postcssModulesValues = _interopRequireDefault(requireSrc());
...
function requirePluginFactory () {
	...
	var _saveJSON = _interopRequireDefault(requireSaveJSON());

	var _localsConvention = requireLocalsConvention();

	var _FileSystemLoader = _interopRequireDefault(requireFileSystemLoader());

	var _scoping = requireScoping();
...
function requireBuild () {
	...
	var _pluginFactory = requirePluginFactory();
